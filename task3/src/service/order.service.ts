...
import { AddressesDoc, Orders, OrdersDoc } from '../schema';
...
export class OrderService {
  ...
  async getLast5FromAddresses(login: string): Promise<string[]> {
    try {
      ...
      const last5Addresses = differentAddresses.slice(-5);
